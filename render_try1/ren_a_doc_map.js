...
let map = L.map('ren_a_doc_map', {  // Change the ID here to ren_a_doc_map
...
const API_URL = process.env.API_URL || 'https://pediatrician.render.com/api/v1.0/locations';  // Replace with actual API URL if needed
